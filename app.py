...
from Book_Recommender_System.config.configuration import AppConfiguration
from Book_Recommender_System.pipeline.training_pipeline import TrainingPipeline
